            ...
            <div class="col-md-6">
                 ...
                 <form method="POST"  name="formPendaftaran" onsubmit="return validateForm()">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="nama_supplier" required maxlength="40" minlength="3" />
                    </div>    
...
<?php 
    ...
    if ($simpan) {
        $sql=$koneksi->query("CALL Add_Supplier('$id_supplier','$nama_supplier','$nomor_telepon','$alamat')");
